...
public class Array2dYAMLDeserializer<T> extends AbstractArray2dYAMLDeserializer<T[][]> {
     ...
     */
    public static <T> Array2dYAMLDeserializer<T> newInstance(YAMLDeserializer<T> deserializer, Array2dCreator<T> arrayCreator) {
    ...
    /**
     * <p>Constructor for Array2dYAMLDeserializer.</p>
     *
     * @param deserializer   {@link YAMLDeserializer} used to deserialize the objects inside the array.
     * @param array2dCreator {@link Array2dYAMLDeserializer.Array2dCreator} used to create a new array
     */
    protected Array2dYAMLDeserializer(YAMLDeserializer<T> deserializer, Array2dCreator<T> array2dCreator) {
    ...
    /** {@inheritDoc} */
    @Override
    protected T[][] doDeserialize(YAMLReader reader, YAMLDeserializationContext ctx, YAMLDeserializerParameters params) {
