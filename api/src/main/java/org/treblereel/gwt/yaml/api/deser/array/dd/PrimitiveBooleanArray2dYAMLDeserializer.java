 ...
 * @version $Id: $
 */
public class PrimitiveBooleanArray2dYAMLDeserializer extends AbstractArray2dYAMLDeserializer<boolean[][]> {

    private static final PrimitiveBooleanArray2dYAMLDeserializer INSTANCE = new PrimitiveBooleanArray2dYAMLDeserializer();

    /**
     * <p>getInstance</p>
     *
     * @return an instance of {@link PrimitiveBooleanArray2dYAMLDeserializer}
     */
    public static PrimitiveBooleanArray2dYAMLDeserializer getInstance() {
        return INSTANCE;
    }

    private PrimitiveBooleanArray2dYAMLDeserializer() {
    }
