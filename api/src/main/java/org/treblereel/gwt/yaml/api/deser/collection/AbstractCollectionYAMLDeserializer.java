...
public class AbstractCollectionYAMLDeserializer<T> extends BaseCollectionYAMLDeserializer<AbstractCollection<T>, T> {
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link AbstractCollection}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.AbstractCollection}.
     * @param <T> Type of the elements inside the {@link java.util.AbstractCollection}
     * @return a new instance of {@link AbstractCollectionYAMLDeserializer}
     */
    public static <T> AbstractCollectionYAMLDeserializer<T> newInstance(YAMLDeserializer<T> deserializer) {
