...
/**
 * Default {@link YAMLDeserializer} implementation for {@link java.util.AbstractList}. The deserialization process returns an {@link java.util.ArrayList}.
...
public class AbstractListYAMLDeserializer<T> extends BaseListYAMLDeserializer<AbstractList<T>, T> {
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link AbstractList}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.AbstractList}.
     * @param <T> Type of the elements inside the {@link java.util.AbstractList}
