...
public class ArrayListYAMLDeserializer<T> extends BaseListYAMLDeserializer<ArrayList<T>, T> {
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link ArrayList}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.ArrayList}.
     * @param <T> Type of the elements inside the {@link java.util.ArrayList}
