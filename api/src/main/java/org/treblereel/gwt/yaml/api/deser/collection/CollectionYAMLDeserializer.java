...
/**
 * Default {@link YAMLDeserializer} implementation for {@link java.util.Collection}. The deserialization process returns an {@link java.util.ArrayList}.
...
public class CollectionYAMLDeserializer<T> extends BaseCollectionYAMLDeserializer<Collection<T>, T> {
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link Collection}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.Collection}.
     * @param <T> Type of the elements inside the {@link java.util.Collection}
