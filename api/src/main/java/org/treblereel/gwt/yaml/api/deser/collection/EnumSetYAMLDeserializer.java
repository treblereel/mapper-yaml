...
public class EnumSetYAMLDeserializer<E extends Enum<E>> extends BaseSetYAMLDeserializer<EnumSet<E>, E> {
    ...
    /**
     * @param deserializer {@link EnumYAMLDeserializer} used to deserialize the enums inside the {@link EnumSet}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link EnumYAMLDeserializer} used to deserialize the enums inside the {@link java.util.EnumSet}.
     * @return a new instance of {@link EnumSetYAMLDeserializer}
     */
    public static <E extends Enum<E>> EnumSetYAMLDeserializer<E> newInstance(EnumYAMLDeserializer<E> deserializer) {
