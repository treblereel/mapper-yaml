...
public class HashSetYAMLDeserializer<T> extends BaseSetYAMLDeserializer<HashSet<T>, T> {
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link HashSet}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.HashSet}.
     * @param <T> Type of the elements inside the {@link java.util.HashSet}
