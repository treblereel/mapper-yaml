...
public class LinkedHashSetYAMLDeserializer<T> extends BaseSetYAMLDeserializer<LinkedHashSet<T>, T> {
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link LinkedHashSet}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.LinkedHashSet}.
     * @param <T> Type of the elements inside the {@link java.util.LinkedHashSet}
