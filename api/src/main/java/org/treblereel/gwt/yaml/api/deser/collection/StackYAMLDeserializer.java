...
public class StackYAMLDeserializer<T> extends BaseListYAMLDeserializer<Stack<T>, T> {
     ...
     * <p>newInstance</p>
     *
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.Stack}.
     * @param <T>          Type of the elements inside the {@link java.util.Stack}
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link Stack}.
     */
