...
public class TreeSetYAMLDeserializer<T> extends BaseSortedSetYAMLDeserializer<TreeSet<T>, T> {
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link TreeSet}.
     */
    ...
    /**
     * <p>newInstance</p>
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.TreeSet}.
     * @param <T> Type of the elements inside the {@link java.util.TreeSet}
