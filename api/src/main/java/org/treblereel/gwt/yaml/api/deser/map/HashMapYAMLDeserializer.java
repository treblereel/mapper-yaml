...
public final class HashMapYAMLDeserializer<K, V> extends BaseMapYAMLDeserializer<HashMap<K, V>, K, V> {
     ...
     */
    private HashMapYAMLDeserializer(YAMLDeserializer<K> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <K, V> HashMapYAMLDeserializer<K, V> newInstance(YAMLDeserializer<K> keyDeserializer,
