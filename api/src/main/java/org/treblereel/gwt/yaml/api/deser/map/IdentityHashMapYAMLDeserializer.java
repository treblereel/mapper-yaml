 ...
 * @version $Id: $
 */
public final class IdentityHashMapYAMLDeserializer<K, V> extends BaseMapYAMLDeserializer<IdentityHashMap<K, V>, K, V> {
     ...
     */
    private IdentityHashMapYAMLDeserializer(YAMLDeserializer<K> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <K, V> IdentityHashMapYAMLDeserializer<K, V> newInstance(YAMLDeserializer<K> keyDeserializer,
