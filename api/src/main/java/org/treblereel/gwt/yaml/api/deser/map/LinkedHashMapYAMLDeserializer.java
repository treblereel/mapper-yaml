...
public final class LinkedHashMapYAMLDeserializer<K, V> extends BaseMapYAMLDeserializer<LinkedHashMap<K, V>, K, V> {
     ...
     */
    private LinkedHashMapYAMLDeserializer(YAMLDeserializer<K> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <K, V> LinkedHashMapYAMLDeserializer<K, V> newInstance(YAMLDeserializer<K> keyDeserializer,
