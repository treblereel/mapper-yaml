...
public final class MapYAMLDeserializer<K, V> extends BaseMapYAMLDeserializer<Map<K, V>, K, V> {
     ...
     */
    private MapYAMLDeserializer(YAMLDeserializer<K> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <K, V> MapYAMLDeserializer<K, V> newInstance(YAMLDeserializer<K> keyDeserializer,
