...
/**
 * Default {@link YAMLDeserializer} implementation for {@link java.util.SortedMap}. The deserialization process returns a {@link java.util.TreeMap}.
 * <p>Cannot be overriden. Use {@link BaseMapYAMLDeserializer}.</p>
 ...
 * @version $Id: $
 */
public final class SortedMapYAMLDeserializer<K, V> extends BaseMapYAMLDeserializer<SortedMap<K, V>, K, V> {
     ...
     */
    private SortedMapYAMLDeserializer(YAMLDeserializer<K> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <K, V> SortedMapYAMLDeserializer<K, V> newInstance(YAMLDeserializer<K> keyDeserializer,
