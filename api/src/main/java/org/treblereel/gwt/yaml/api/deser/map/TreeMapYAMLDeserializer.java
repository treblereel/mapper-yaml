 ...
 * @version $Id: $
 */
public final class TreeMapYAMLDeserializer<K, V> extends BaseMapYAMLDeserializer<TreeMap<K, V>, K, V> {
     ...
     */
    private TreeMapYAMLDeserializer(YAMLDeserializer<K> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <K, V> TreeMapYAMLDeserializer<K, V> newInstance(YAMLDeserializer<K> keyDeserializer,
