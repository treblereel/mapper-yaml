...
public class IterableYAMLSerializer<I extends Iterable<T>, T> extends YAMLSerializer<I> {
    ...
    /**
     * <p>Constructor for IterableYAMLSerializer.</p>
     * @param serializer {@link YAMLSerializer} used to serialize the objects inside the {@link Iterable}.
     */
     ...
     */
    public static <I extends Iterable<?>> IterableYAMLSerializer<I, ?> newInstance(YAMLSerializer<?> serializer) {
