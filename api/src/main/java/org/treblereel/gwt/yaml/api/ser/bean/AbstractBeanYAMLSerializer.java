 ...
 * @version $Id: $
 */
public abstract class AbstractBeanYAMLSerializer<T> extends YAMLSerializer<T> implements InternalSerializer<T> {
    ...
    /**
     * <p>Constructor for AbstractBeanYAMLSerializer.</p>
     */
    ...
    /**
     * Initialize the {@link TypeSerializationInfo}. Returns null if there is no { YAMLTypeInfo} annotation on bean.
     ...
     */
    @Override
    public void doSerialize(YAMLWriter writer, T value, YAMLSerializationContext ctx, YAMLSerializerParameters params) {
     ...
     * {@inheritDoc}
     */
    public void serializeInternally(YAMLWriter writer, T value, YAMLSerializationContext ctx, YAMLSerializerParameters params,
     ...
     */
    protected void serializeObject(YAMLWriter writer, T value, YAMLSerializationContext ctx,
                                   String typeName, TypeSerializationInfo typeInformation) {
