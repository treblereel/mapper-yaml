 ...
 * @version $Id: $
 */
public final class GwtYAMLDeserializerParameters implements YAMLDeserializerParameters {

  /** Constant <code>DEFAULT</code> */
  public static final YAMLDeserializerParameters DEFAULT = new GwtYAMLDeserializerParameters();
