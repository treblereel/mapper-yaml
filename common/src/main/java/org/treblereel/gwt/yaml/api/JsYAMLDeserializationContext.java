...
public class JsYAMLDeserializationContext implements YAMLDeserializationContext {
  ...
  private JsYAMLDeserializationContext(
  ...
  /**
   * Builder for {@link YAMLDeserializationContext}. To override default settings globally, you can
  ...
  public static class Builder {
     ...
     * with packages (such as YAML-to-JSON converters) that leave out JSON array in cases where
     * there is just a single element in array.
     *
    ...
    public final YAMLDeserializationContext build() {
      return new JsYAMLDeserializationContext(
