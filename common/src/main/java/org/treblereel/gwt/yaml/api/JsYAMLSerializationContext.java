...
public class JsYAMLSerializationContext implements YAMLSerializationContext {
  ...
  /**
   * Builder for {@link YAMLSerializationContext}. To override default settings globally, you can
   * extend this class, modify the default settings inside the constructor and tell the compiler to
   * use your builder instead in your gwt.yaml file :
   *
   * <pre>{@code
  ...
  public static class Builder {
     ...
     * @return the builder
     */
    public JsYAMLSerializationContext.Builder useEqualityForObjectId(
        boolean useEqualityForObjectId) {
      this.useEqualityForObjectId = useEqualityForObjectId;
      return this;
    }

    public JsYAMLSerializationContext.Builder mapKeyAndValueCanonical(
        boolean mapKeyAndValueCanonical) {
      this.mapKeyAndValueCanonical = mapKeyAndValueCanonical;
      return this;
    }
     ...
     * @return the builder
     */
    public JsYAMLSerializationContext.Builder writeDatesAsTimestamps(
        boolean writeDatesAsTimestamps) {
      this.writeDatesAsTimestamps = writeDatesAsTimestamps;
      return this;
    }
     ...
     * @return the builder
     */
    public JsYAMLSerializationContext.Builder writeDateKeysAsTimestamps(
        boolean writeDateKeysAsTimestamps) {
      this.writeDateKeysAsTimestamps = writeDateKeysAsTimestamps;
      return this;
    }
    ...
    public final YAMLSerializationContext build() {
      return new JsYAMLSerializationContext(
          serializeNulls,
          writeDatesAsTimestamps,
          writeDateKeysAsTimestamps,
          writeNullMapValues,
          writeEmptyYAMLArrays,
          orderMapEntriesByKeys,
          mapKeyAndValueCanonical,
          wrapExceptions,
          wrapCollections);
    }
  }
