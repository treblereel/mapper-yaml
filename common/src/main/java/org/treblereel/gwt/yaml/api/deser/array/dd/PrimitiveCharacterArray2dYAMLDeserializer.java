 ...
 * @version $Id: $
 */
public class PrimitiveCharacterArray2dYAMLDeserializer extends AbstractArray2dYAMLDeserializer<char[][]> {

    private static final PrimitiveCharacterArray2dYAMLDeserializer INSTANCE = new PrimitiveCharacterArray2dYAMLDeserializer();
     ...
     */
    @Override
    public char[][] doDeserialize(YamlMapping yaml, String key, YAMLDeserializationContext ctx, YAMLDeserializerParameters params) {
        List<List<Character>> list = deserializeIntoList(yaml.yamlSequence(key), ctx, CharacterYAMLDeserializer.getInstance(), params);
