 ...
 * @version $Id: $
 */
public class PrimitiveLongArray2dYAMLDeserializer extends AbstractArray2dYAMLDeserializer<long[][]> {

    private static final PrimitiveLongArray2dYAMLDeserializer INSTANCE = new PrimitiveLongArray2dYAMLDeserializer();
