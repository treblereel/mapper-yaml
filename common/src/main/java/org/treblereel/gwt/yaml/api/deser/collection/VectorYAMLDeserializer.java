...
public class VectorYAMLDeserializer<T> extends BaseListYAMLDeserializer<Vector<T>, T> {
     ...
     * <p>newInstance</p>
     *
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link java.util.Vector}.
     * @param <T>          Type of the elements inside the {@link java.util.Vector}
    ...
    /**
     * @param deserializer {@link YAMLDeserializer} used to deserialize the objects inside the {@link Vector}.
     */
