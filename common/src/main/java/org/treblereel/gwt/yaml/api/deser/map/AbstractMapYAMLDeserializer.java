...
/**
 * Default {@link YAMLDeserializer} implementation for {@link java.util.AbstractMap}. The deserialization process returns a {@link java.util.LinkedHashMap}.
...
public final class AbstractMapYAMLDeserializer<K, V> extends BaseMapYAMLDeserializer<AbstractMap<K, V>, K, V> {
     ...
     */
    private AbstractMapYAMLDeserializer(YAMLDeserializer<K> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <K, V> AbstractMapYAMLDeserializer<K, V> newInstance(YAMLDeserializer<K> keyDeserializer,
