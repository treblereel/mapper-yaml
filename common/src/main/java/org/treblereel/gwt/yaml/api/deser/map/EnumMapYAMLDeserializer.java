...
public final class EnumMapYAMLDeserializer<E extends Enum<E>, V> extends BaseMapYAMLDeserializer<EnumMap<E, V>, E, V> {
     ...
     */
    private EnumMapYAMLDeserializer(EnumYAMLDeserializer<E> keyDeserializer, YAMLDeserializer<V> valueDeserializer) {
     ...
     */
    public static <E extends Enum<E>, V> EnumMapYAMLDeserializer<E, V> newInstance(EnumYAMLDeserializer<E> keyDeserializer,
