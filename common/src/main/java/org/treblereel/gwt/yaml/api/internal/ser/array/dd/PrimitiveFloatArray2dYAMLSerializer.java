...
/**
 * Default {@link AbstractYAMLSerializer} implementation for 2D array of float.
 *
...
public class PrimitiveFloatArray2dYAMLSerializer extends BasicArrayYAMLSerializer<float[][]> {
  ...
  /** {@inheritDoc} */
  @Override
  public void doSerialize(YamlMapping writer, float[][] values, YAMLSerializationContext ctx) {
