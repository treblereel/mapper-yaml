...
public final class DefaultDateFormat implements YAMLContext.DateFormat {
     ...
     * {@inheritDoc}
     *
     * Format a date using {@link YAMLSerializerParameters} or default values : {@link #DATE_FORMAT_STR_ISO8601} and {@link #UTC_TIMEZONE}
     */
    public String format(YAMLSerializerParameters params, Date date) {
