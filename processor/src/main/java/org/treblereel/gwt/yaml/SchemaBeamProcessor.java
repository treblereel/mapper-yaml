...
public class SchemaBeamProcessor extends AbstractProcessor {

  private final PrintWriterTreeLogger logger = new PrintWriterTreeLogger();

  @Override
  public Set<String> getSupportedAnnotationTypes() {
    return Set.of(YamlSchema.class.getCanonicalName());
  }
  ...
  public boolean process(
    ...
    if (!annotations.isEmpty()) {
      ...
      processSchemaGeneration(roundEnvironment, context);
    }
    return false;
  }
