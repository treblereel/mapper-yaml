...
class NamingUtilsTest {
  ...
  @Test
  void needsYamlPropertyWhenDifferent() {
    assertTrue(NamingUtils.needsYamlProperty("zip-code", "zipCode"));
  }

  @Test
  void needsYamlPropertyWhenSame() {
    assertFalse(NamingUtils.needsYamlProperty("name", "name"));
  }
