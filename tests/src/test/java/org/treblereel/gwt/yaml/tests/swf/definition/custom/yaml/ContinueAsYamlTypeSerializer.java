...
import org.treblereel.gwt.yaml.tests.swf.definition.ContinueAs;
import org.treblereel.gwt.yaml.tests.swf.definition.ContinueAs_YamlMapperImpl;
...
public class ContinueAsYamlTypeSerializer implements YAMLDeserializer, YAMLSerializer {
  ...
  public void serialize(
    ...
    if (value instanceof String) {
      ...
      continueAsYamlSerializerImpl
          .getSerializer()
          .serialize(writer, propertyName, (ContinueAs) value, ctx);
    }
  }
