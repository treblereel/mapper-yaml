...
import org.treblereel.gwt.yaml.tests.swf.definition.Metadata;
import org.treblereel.gwt.yaml.tests.swf.definition.ValueHolder;

public class MetadataYamlSerializer
    implements YAMLSerializer<Metadata>, YAMLDeserializer<Metadata> {

  private static final ValueHolderYamlTypeSerializer valueHolderYamlTypeSerializer =
      new ValueHolderYamlTypeSerializer();

  private static final StringYAMLDeserializer stringYAMLDeserializer = new StringYAMLDeserializer();

  @Override
  public Metadata deserialize(YamlMapping yaml, String key, YAMLDeserializationContext ctx)
  ...
  public void serialize(
      YamlMapping writer, String propertyName, Metadata metadata, YAMLSerializationContext ctx) {
  ...
  private void writeObjectProps(
      YamlMapping writer, Metadata metadata, YAMLSerializationContext ctx) {
    if (metadata != null) {
      valueHolderYamlTypeSerializer.serialize(
          writer, "metadata", Js.<ValueHolder>uncheckedCast(metadata), ctx);
    }
  }
}
