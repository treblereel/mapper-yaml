...
import org.treblereel.gwt.yaml.tests.swf.definition.Schedule;
import org.treblereel.gwt.yaml.tests.swf.definition.Schedule_YamlMapperImpl;

public class ScheduleYamlTypeSerializer implements YAMLDeserializer, YAMLSerializer {

  private static final Schedule_YamlMapperImpl mapper = Schedule_YamlMapperImpl.INSTANCE;
