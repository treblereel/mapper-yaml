...
import org.treblereel.gwt.yaml.tests.swf.definition.StartDefinition;
import org.treblereel.gwt.yaml.tests.swf.definition.StartDefinition_YamlMapperImpl;
...
public class StartDefinitionYamlTypeSerializer implements YAMLDeserializer, YAMLSerializer {
  ...
  public void serialize(
    ...
    if (value instanceof String) {
      ...
      startDefinitionYamlSerializerImpl
          .getSerializer()
          .serialize(writer, propertyName, (StartDefinition) value, ctx);
    }
  }
  ...
  public void serialize(YamlSequence writer, Object value, YAMLSerializationContext ctx) {
    if (value instanceof String) {
      ...
      startDefinitionYamlSerializerImpl
          .getSerializer()
          .serialize(writer, (StartDefinition) value, ctx);
    }
  }
}
